...
import TermsModal from 'common/components/footer/TermsModal'
...
const Footer = () => {
   ...
   return (
      <>
         <TermsModal isOpen={isModalOpen} close={toggleModal} />
               ...
               <div className='footer__content-wrapper'>
                  <div className='footer__content'>
                     ...
                     <p className='footer__text'>
                        "If war is madness then Rhelegus is living in the apocalypse" - The True Gods of Xorbin. 7777
                        Programmatically Generated Unique NFTs waiting to be awakened on the ETH Blockchain.
                     </p>
                     <div className='footer__socials'>
                        <a href={TWITTER_LINK} target='_blank' rel='noreferrer' className='footer__socialLink'>
                           <img src={TwitterIcon} alt='' className='footer__socialLink-icon' />
                        </a>
                        <a href={INSTAGRAM_LINK} target='_blank' rel='noreferrer' className='footer__socialLink'>
                           <img src={InstagramIcon} alt='' className='footer__socialLink-icon' />
                        </a>
                        <a href={DISCORD_LINK} target='_blank' rel='noreferrer' className='footer__socialLink'>
                  ...
                  <div className='footer__links-wrapper'>
                     <div className='footer__links'>
                        <h4 className='footer__links-heading'>SITE MENU</h4>
                     ...
                     <div className='footer__links'>
                        <h4 className='footer__links-heading'>Useful Links</h4>
                     ...
                     <div className='footer__links'>
                        <h4 className='footer__links-heading'>Information</h4>
                        ...
                        <button onClick={toggleModal} className='footer__link'>Terms and conditions</button>
                     </div>
                  </div>
               </div>
               <div className='footer__rights'>
                  <div className='footer__rights-content'>
                     2021-22 - Developed by <span>Rhelegus Team</span>
                  </div>
                  <div className='footer__rights-content'>All Rights Reserved.</div>
               </div>
            </div>
         </footer>
      </>
